...
[![Version](https://img.shields.io/badge/Version-1.0-orange)](https://github.com/Lutfifakee-Project/SubRecon-Python)
...
git clone https://github.com/Lutfifakee-Project/SubRecon-Python
cd SubRecon-Python
...
Available formats:
- JSON (.json) - API integration & other tools
- CSV (.csv) - Analysis in Excel/Google Sheets
- TXT (.txt) - Human-readable text report
- HTML (.html) - Professional visual report (dark mode)
